...
def send_command_to_server(command):
    ...
    try:
        ...
        return f"Erro ao enviar comando para o servidor: {e}"
...
def default_response_handler(mensagem):
